...
class User extends Authenticatable
{
    ...
    public function articles() {
        return $this->hasMany(Article::class,'articles_user_id_foreign');
    }

    public function comments() {
        return $this->hasMany(Comment::class,'comments_user_id_foreign');
    }

    public function votes()
    {
        return $this->hasMany(Vote::class,'votes_user_id_foreign');
    }
